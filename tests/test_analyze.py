...
class TestFormatTraveler:
    ...
    def test_format_traveler_with_null_age(self):
        """Test formatting a traveler with age: null (None in Python)."""
        traveler = {"name": "Dad", "age": None}
        assert format_traveler(traveler) == "Dad"
